    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property({
        ...
        async initGame() {
          ...
          let parameters = find("GameClient");
          let gameClientParams = parameters.getComponent(_crd && StoredAPI === void 0 ? (_reportPossibleCrUseOfStoredAPI({
            error: Error()
          }), StoredAPI) : StoredAPI);
          this.gameClient = gameClientParams.gameClient;
          this.GameView.LoadingText.active = true;
...
//# sourceMappingURL=3b9be2cc1bcb92e1d3535987cfc12df2008fd6c5.js.map